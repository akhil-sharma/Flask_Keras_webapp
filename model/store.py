...
def build_model(training_set_path, test_set_path, common_batch_size=32, n_epochs=25):
    ...
    training_set = training_datagen.flow_from_directory(training_set_path, target_size=(128, 128),
                                                        batch_size=common_batch_size, class_mode='binary')

    test_datagen = ImageDataGenerator(rescale=1. / 255)
    test_set = test_datagen.flow_from_directory(test_set_path, target_size=(128, 128), batch_size=common_batch_size,
                                                class_mode='binary')

    # Fitting the dataset to the classifier
    classifier.fit_generator(training_set, steps_per_epoch=8000 / common_batch_size, epochs=n_epochs,
